  ...
  if (!isStudio) {
    return (
      <div className="min-h-screen w-full flex flex-col bg-[#18181b]">
        <header
          className="w-full px-6 md:py-2 bg-transparent fixed top-0 left-0 right-0 z-40 flex flex-col items-center sm:flex-row sm:justify-between sm:items-center"
